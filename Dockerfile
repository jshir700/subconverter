...
ARG BUILD_DATE=""
LABEL \
  org.opencontainers.image.title="subconverter" \
  org.opencontainers.image.description="subconverter - subscription converter" \
  org.opencontainers.image.url="https://github.com/tindy2013/subconverter" \
  org.opencontainers.image.source="https://github.com/tindy2013/subconverter" \
  org.opencontainers.image.licenses="GPL-3.0" \
  org.opencontainers.image.version="${VERSION}" \
  org.opencontainers.image.revision="${SHA}" \
  org.opencontainers.image.created="${BUILD_DATE}" \
  maintainer="tindy2013"
